...
Chat Play는 채팅을 중심으로 다양한 기능을 자연스럽게 확장한
챗봇 기반 커뮤니케이션 서비스이다.

사용자는 챗봇을 매개로 여러 필요한 기능을 즉시 호출하고
다른 사용자들과 함께 공유할 수 있다.
Chat Play는 단순한 명령어 입력형 챗봇이 아니라,
**대화 흐름 속에서 기능을 선택하고 참여하도록 설계된 시스템으로,
사용자 간 상호작용을 중심에 둔 경험을 제공한다.**
