...
public class CatchMindFrame extends JFrame {
    ...
    private JPanel createToolPanel() {
        ...
        for (Color c : colors) {
            ...
            colorBtn.addActionListener(e -> drawingPanel.setPenColor(c));
            panel.add(colorBtn);
        }
        ...
        sizeSlider.addChangeListener(e -> drawingPanel.setPenSize(sizeSlider.getValue()));
        
        panel.add(sizeLabel);
        panel.add(sizeSlider);
        
        // 지우기 버튼
        JButton clearBtn = new JButton("전체 지우기");
    ...
    public void onCorrectAnswer(String username, String word) {
        for (GamePlayer p : players) {
        ...
        answerLabel.setText(word);
        updatePlayerPanel();
        appendChat("🎉 " + username + "님이 정답을 맞췄습니다!");
    }
